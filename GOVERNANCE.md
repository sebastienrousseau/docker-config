...
This document describes how @sebastienrousseau/docker-config is run: who decides what, how
...
@sebastienrousseau/docker-config is **maintainer-led**. As of the current release line it has a single
